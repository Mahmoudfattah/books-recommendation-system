...
//lazm tnazl el maktapa btaat react-loader-spinner
...
//   async function submitFomt(values) {

//     setLoading(true)
//     let { data } = await axios.post(` api `, values).catch((err) => {
...
//           <input type='text' className='form-control mb-3' id='name' name='name' onBlur={formik.handleBlur} values={formik.values.name} onChange={formik.handleChange}></input>
...
//           <input type='password' className='form-control mb-3' id='rePassword' name='rePassword' values={formik.values.rePassword} onChange={formik.handleChange} onBlur={formik.handleBlur}></input>
//           {formik.errors.rePassword && formik.touched.rePassword ? <p className='alert alert-danger'> {formik.errors.rePassword} </p> : ''}
//           <label htmlFor='phone'>phone:</label>


//           <input type='number' className='form-control mb-3' id='phone' name='phone' values={formik.values.phone} onChange={formik.handleChange} onBlur={formik.handleBlur}></input>
