...
//         navigate(`/Srchbook/${matchingBook.slug}`);
//       } else {
...
//             {searchResults.map(
//               (
//                 book // Render search results
//               ) => (
//                 <li key={book._id} className="nav-item">
//                   <Link className="nav-link" to={`/book/${book.slug}`}>
//                     {book.title}
//                   </Link>
//                 </li>
//               )
...
//                                 <Link to='/Fantasy'><li><a className="dropdown-item" href="#">Fantasy </a></li></Link>
